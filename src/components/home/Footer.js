          ...
          <div className="row">
            <div className="col-md-3 footer2 text-left">
              ...
              <p className="text-white text-left">
                ...
                Silks, KPHB Colony Hyderabad TS-500085 +91 9951013133, +91
                9951013134
              </p>
              <a href="/">
                {" "}
            ...
            <div className="col-md-3 footer2 text-left">
              ...
              <Link to="/bolg" className="mt-3">
                <h6 className="text-white">Bolg</h6>
              </Link>
            ...
            <div className="col-md-3 footer2 text-left">
              ...
              <p className="text-white" style={{ paddingLeft: "70px" }}>
                jun, 2019
              </p>
              <div className="" style={{ display: "flex" }}>
                <img
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 text-right">
              <Link to="/privacypolicy" className="text-white pp">
                Privacy Policy
              </Link>
              &nbsp;&nbsp;
              <Link to="/termsconditions" className="text-white pp">
                Terms & Conditions
              </Link>
            </div>
          </div>
