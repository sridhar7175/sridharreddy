        ...
        <div>
            <div className="student1">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-8">
                            <div className="student2">
                                <h4 >Get A Free<span style={{ color: "#FFBC09" }}>Online Courses</span></h4>
                                ...
                                <form>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <input type="text" name="name" className="lastname"
                                                    id="lastname" placeholder="Enter Phone*" />
                                            </div>
                                            <div class="col-md-6 mt-3">
                    ...
                    <img src="images/student.png" width="300px" height="700px"/>
                    </div>
                    </div>
