        ...
        <div>
            <div className="contact1">
                <div className="container">
                    ...
                    <p className="text-center">Contact us for any training requirements you have.</p>
                    <div className="row">
                        <div className="col-md-6 mt-5">
                            <div className="contact2">
                                <form>
                                    <input type="text" className="mt-5" style={{ width: "470px", height: "40px" }}
                                        placeholder="Enter Name.." />
                                    <input type="text" className="mt-3" style={{ width: "470px", height: "40px" }}
                                        id="fname" name="firstname" placeholder="Enter Email.." />
                                    <input type="text" className="mt-3" style={{ width: "470px", height: "40px" }}
                                        id="fname" name="firstname" placeholder="Enter Mobile.." />
                                    <input type="text" className="mt-3" style={{ width: "470px", height: "40px" }}
                                        id="fname" name="firstname" placeholder="Enter Subject.." />
                                    <textarea id="subject" className="mt-3" style={{ width: "470px", height: "100px" }}
                                        name="subject" placeholder="Message.."></textarea>
                                    <button type="button" className="btn btn-danger mt-3 w-50">Submit</button>
                                </form>
                            </div>
            ...
            <div className="contact3">
                ...
                <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there<br/>
                isn't anything embarrassing hidden in the middle of text</p>
                    <div className="contact4">
                        <div className="row">
                            ...
                            <h6 className="mt-2 text-white">MIG 27/1, Road #6, Dharma Reddy
                            Colony, Phase 1 Behind VRK Silks, KPHB Colony Hyderabad TS-500072.</h6>
                            </div>
                            </div>
                            <div className="col-md-4 mt-4">
