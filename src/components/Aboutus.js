             ...
             <div className="container-fluid">
                 <div className="row">
                     <div className="col-md-6">
                         <h2>About Us</h2>
                         <p>‘DEVA’ is an expert level ‘skill development center’ started by industry veterans,
                      having a solid 3 year experience in the Hyderabad in multiple technologies.</p>
